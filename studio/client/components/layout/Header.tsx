...
interface HeaderProps {
    context?: "playground" | "home" | "studio"
}

// Configuración base de enlaces de navegación
const NAV_BASE = [
    { href: "#", key: "home", label: "Inicio" },
    { href: "#features", key: "why", label: "Por qué" },
    { href: "#templates", key: "templates", label: "Plantillas" },
    { href: "#como-funciona", key: "how", label: "Cómo funciona" },
    { href: "#api", key: "api", label: "API" },
    { href: "#hoja-de-ruta", key: "roadmap", label: "Hoja de ruta" },
    { href: "#casos-uso", key: "usecases", label: "Casos de uso" },

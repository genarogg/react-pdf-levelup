  ...
  return (
    <LayoutPDF size="A4" padding={30} showPageNumbers={false}>
      ...
      <View style={{ marginBottom: 15, padding: 10, backgroundColor: "#f9f9f9" }}>
        ...
        <Row>
          <Col6>
            <P><Strong>Nombre:</Strong> {invoiceData.client.name}</P>
            <P><Strong>Dirección:</Strong> {invoiceData.client.address}</P>
          </Col6>
          <Col6>
            <P><Strong>NIT/CI:</Strong> {invoiceData.client.nit}</P>
            <P><Strong>Teléfono:</Strong> {invoiceData.client.phone}</P>
          </Col6>
        </Row>
      </View>
          ...
          <Col4>
            <Table>
              <Tbody>
                ...
                <Tr>
                  <Td style={{ width: "50%" }}><Strong>IVA (13%):</Strong></Td>
                  <Td style={{ width: "50%", textAlign: "right" }}>{invoiceData.tax} Bs</Td>
                </Tr>
                <Tr>
                  <Td style={{ width: "50%", backgroundColor: "#f0f0f0" }}><Strong>TOTAL:</Strong></Td>
                  <Td style={{ width: "50%", textAlign: "right", backgroundColor: "#f0f0f0" }}><Strong>{invoiceData.total} Bs</Strong></Td>
                </Tr>
              </Tbody>
            </Table>
          </Col4>

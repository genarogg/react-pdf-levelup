        ...
        >
          ...
          <View style={{ marginBottom: 30, alignItems: "center" }}>
            ...
            <Text style={{ fontSize: 12, marginBottom: 10, textAlign: "center", maxWidth: 500 }}>
              Por su destacada participación en el evento <Strong>{certificadoData.evento}</Strong>, realizado el{" "}
              {certificadoData.fecha}, con una duración de {certificadoData.horas} horas académicas.
            </Text>
          </View>
          ...
          <View style={{ marginTop: 40, alignItems: "center" }}>
            <View style={{ width: 200, borderTop: "1px solid #000", paddingTop: 5 }}>
              ...
              <Text style={{ fontSize: 10, textAlign: "center" }}>{certificadoData.firma.cargo}</Text>
            </View>
          </View>

          {/* Pie */}
          <View style={{ marginTop: 30, flexDirection: "row", justifyContent: "space-between", width: "100%" }}>
            <Text style={{ fontSize: 8, color: "#666" }}>Código de verificación: {certificadoData.codigo}</Text>
            <QR value={`https://verificar.org/cert/${certificadoData.codigo}`} size={60} colorDark="#003366" />
          </View>
        </View>
      </View>
    </LayoutPDF>

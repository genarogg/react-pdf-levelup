...
Utilidad de frontend para decodificar un PDF en base64 generados con @react-pdf-levelup/core y descargarlo/abrirlo/imprimirlo en el navegador.
...
Decodifica un string en base64 correspondiente a un PDF y abre el diálogo de impresión del navegador. Limpia automáticamente los recursos después de 3 segundos.
...
### Ejemplo básico (decodeBase64Pdf)
...
### Ejemplo tras generar el PDF (decodeBase64Pdf)
...
### Ejemplo de impresión (printBase64Pdf)
